...
4:{"tip": "tip_0", "vprasanje": "Kakšen je program za skupinske sestave?", "odgovor": "3+2, 5"},
...
7:{"tip": "tip_0", "vprasanje": "Kdo odbije odbitek za predolg glasbeni uvod?", "odgovor": "E1, E2"},
...
11:{"tip": "tip_0", "vprasanje": "Kdo odbije odbitke če glasba ni v skladu s pravilnikom?", "odgovor": "D1"},
...
6:{"tip":"tip_1", "vprasanje": "Koliko je vredna težina na sliki 6?", "odgovor": "0.4",
...
18:{"tip":"tip_1", "vprasanje": "Koliko je vredna težina na sliki 18?", "odgovor": "0.5",
...
riziki = {1:{"tip": "tip_2",
 "vprasanje": [{"vpr": "Kateri kriteriji se nanašajo na prvi rizik?", "odg": ["3 rotacije", "met z rotacijo okoli svoje osi (diametralni met)", "met izven vidnega polja", "met brez pomoči rok", "sprememba nivoja/osi", "ujem izven vidnega polja", "ujem brez pomoči rok", "ujem v rotacijo "]},
 {"vpr": "Kateri kriteriji se nanašajo na drugi rizik?", "odg": ["3 rotacije", "sprememba nivoja/osi", "ujem izven vidnega polja", "ujem brez pomoči rok", "ujem v rotacijo "]},
 {"vpr": "Kateri kriteriji se nanašajo na tretji rizik?", "odg": ["3 rotacije", "met z rotacijo okoli svoje osi (diametralni met)", "met izven vidnega polja", "met brez pomoči rok", "sprememba nivoja/osi", "ujem izven vidnega polja", "ujem v rotacijo "]},
 {"vpr": "Kateri kriteriji se nanašajo na četrti rizik?", "odg": ["3 rotacije", "položni met", "sprememba nivoja/osi", "ujem izven vidnega polja", "ujem brez pomoči rok", "ujem v rotacijo "]},
 {"vpr": "Kateri kriteriji se nanašajo na peti rizik?", "odg": ["3 rotacije", "sprememba nivoja/osi", "ujem izven vidnega polja", "ujem brez pomoči rok", "ujem v rotacijo "]}],
 "mozni_odg": ["2 rotaciji", "3 rotacije", "4 rotacije", "položni met", "met z rotacijo okoli svoje osi (diametralni met)", "met izven vidnega polja", "met brez pomoči rok", "sprememba nivoja/osi", "ujem izven vidnega polja", "ujem brez pomoči rok", "ujem v rotacijo "],
 "video": "https://www.youtube.com/watch?v=ZOPpRz0bwRQ"},
 2:{"tip": "tip_2",
 "vprasanje": [{"vpr": "Kateri kriteriji se nanašajo na prvi rizik?", "odg": ["4 rotacije", "met izven vidnega polja", "sprememba nivoja/osi"]},
 {"vpr": "Kateri kriteriji se nanašajo na drugi rizik?", "odg": ["3 rotacije", "sprememba nivoja/osi", "ujem izven vidnega polja", "ujem v eno roko", "ujem v rotacijo ", "jete en tournant with back bend 0.6"]},
 {"vpr": "Kateri kriteriji se nanašajo na tretji rizik?", "odg": ["4 rotacije", "sprememba nivoja/osi", "ujem izven vidnega polja", "ujem v eno roko", "ujem v rotacijo "]},
 {"vpr": "Kateri kriteriji se nanašajo na četrti rizik?", "odg": ["3 rotacije", "sprememba nivoja/osi", "ujem izven vidnega polja", "jete en tournant with ring 0.5"]}],
 "mozni_odg": ["2 rotaciji", "3 rotacije", "4 rotacije", "met izven vidnega polja", "met brez pomoči rok", "sprememba nivoja/osi", "ujem izven vidnega polja", "ujem brez pomoči rok", "ujem v eno roko", "ujem v rotacijo ", "jete en tournant with back bend 0.6", "jete en tournant with ring 0.5"],
 "video": "https://www.youtube.com/watch?v=HjqlQ8VnKqw"},
 3:{"tip": "tip_2",
 "vprasanje": [{"vpr": "Kateri kriteriji se nanašajo na prvi rizik?", "odg": ["4 rotacije", "met z rotacijo okoli svoje osi (diametralni met)", "met izven vidnega polja", "met brez pomoči rok", "sprememba nivoja/osi"]},
  {"vpr": "Kateri kriteriji se nanašajo na drugi rizik?", "odg": ["4 rotacije", "met z rotacijo okoli svoje osi (diametralni met)", "met izven vidnega polja", "sprememba nivoja/osi", "ujem brez pomoči rok"]},
  ...
  {"vpr": "Kateri kriteriji se nanašajo na peti rizik?", "odg": ["3 rotacije", "met z rotacijo okoli svoje osi (diametralni met)", "met brez pomoči rok", "sprememba nivoja/osi"]}],
 "mozni_odg": ["2 rotaciji", "3 rotacije", "4 rotacije", "met z rotacijo okoli svoje osi (diametralni met)", "met izven vidnega polja", "met brez pomoči rok", "met dveh kijev", "sprememba nivoja/osi", "ujem izven vidnega polja", "ujem brez pomoči rok", "ujem v rotacijo "],
 "video": "https://www.youtube.com/watch?v=wP5e27_0v04"},
 4:{"tip": "tip_2",
 "vprasanje": [{"vpr": "Kateri kriteriji se nanašajo na prvi rizik?", "odg": ["5 rotacij", "sprememba nivoja/osi", "ujem izven vidnega polja", "ujem v rotacijo"]},
 {"vpr": "Kateri kriteriji se nanašajo na drugi rizik?", "odg": ["4 rotacije", "met izven vidnega polja", "met brez pomoči rok", "sprememba nivoja/osi", "ujem izven vidnega polja", "ujem v rotacijo "]},
 {"vpr": "Kateri kriteriji se nanašajo na tretji rizik (v primeru dobre izvedbe)?", "odg": ["4 rotacije", "met izven vidnega polja", "sprememba nivoja/osi", "ujem izven vidnega polja", "ujem v rotacijo "]},
 {"vpr": "Kateri kriteriji se nanašajo na četrti rizik?", "odg": ["3 rotacije", "sprememba nivoja/osi"]}],
 "mozni_odg": ["3 rotacije", "4 rotacije", "5 rotacij", "met izven vidnega polja", "met brez pomoči rok", "sprememba nivoja/osi", "ujem izven vidnega polja", "ujem brez pomoči rok", "ujem v rotacijo "],
